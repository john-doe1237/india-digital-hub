...
// Ashoka Chakra — 24-spoke decorative SVG
...
function PulsingRing() {
  return (
    ...
    >
      ...
      />
      <div className="w-8 h-8 rounded-full border-2 border-transparent border-t-primary border-r-primary/40 animate-spin" />
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        style={{
          background:
            "linear-gradient(135deg, oklch(0.62 0.24 280) 0%, oklch(0.48 0.22 250) 100%)",
          boxShadow:
            "0 4px 28px oklch(0.55 0.22 280 / 0.55), inset 0 1px 0 rgba(255,255,255,0.18)",
        }}
        whileTap={{ scale: 0.96 }}
      ...
      >
        ...
        {isAuthenticating ? (
          ...
          <>
            ...
            <span className="relative z-10">Fingerprint se Login Karo</span>
          </>
        )}
      </motion.button>
      ...
      >
        ...
        />
        <span className="text-xs" style={{ color: "oklch(0.5 0.01 250)" }}>
          ya
        </span>
        <div
          className="flex-1 h-px"
...
export function SplashPage() {
  ...
  const [biometricErrorMsg, setBiometricErrorMsg] = useState<string | null>(
    null,
  );
  ...
  const handleBiometricLogin = async () => {
    ...
    if (success) {
      toast.success("Fingerprint se login ho gaya! 🎉");
      navigate({ to: "/home" });
    } else {
      const msg =
        biometricError ?? "Fingerprint login fail hua — dobara try karo";
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(ellipse 120% 80% at 50% 0%, oklch(0.22 0.12 280) 0%, oklch(0.15 0.08 260) 40%, oklch(0.08 0 0) 100%)",
      }}
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, oklch(0.75 0.18 54) 0%, oklch(0.8 0.21 54) 50%, oklch(0.75 0.18 54) 100%)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.45 0.2 240) 0%, transparent 70%)",
          filter: "blur(80px)",
        }}
      />

      {/* Main content */}
      <div className="relative z-10 flex flex-col items-center gap-6 px-6 text-center max-w-sm mx-auto w-full">
        {/* Logo */}
        <motion.div
        ...
        >
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, oklch(0.68 0.22 256 / 0.25) 0%, transparent 70%)",
            }}
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.55 0.22 280) 0%, oklch(0.45 0.2 250) 100%)",
              boxShadow:
                "0 8px 32px oklch(0.55 0.22 280 / 0.5), inset 0 1px 0 rgba(255,255,255,0.15)",
            }}
          >
            <Fingerprint
        ...
        >
          ...
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent, oklch(0.75 0.18 54), transparent)",
            }}
            aria-hidden="true"
          />
        </motion.div>
          ...
          {isAuthenticated ? (
            ...
            <>
              ...
              <motion.button
                ...
                style={{
                  background:
                    "linear-gradient(135deg, oklch(0.6 0.22 280) 0%, oklch(0.5 0.2 250) 100%)",
                  boxShadow:
                    "0 4px 24px oklch(0.55 0.22 280 / 0.45), inset 0 1px 0 rgba(255,255,255,0.15)",
                  fontFamily: "Inter, Montserrat, sans-serif",
                }}
                whileTap={{ scale: 0.96 }}
                whileHover={{ scale: 1.03 }}
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, oklch(0.7 0.19 142) 0%, oklch(0.65 0.2 145) 50%, oklch(0.7 0.19 142) 100%)",
